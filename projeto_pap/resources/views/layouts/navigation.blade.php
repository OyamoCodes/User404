            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('game/assets/images/icon.png') }}" alt="Logo TeachPlayLearn" class="logo" style="height: 55px; width: 55px;" />
                    </a>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')">
                            <i class="fa-regular fa-circle-user"></i>{{ __('Profile') }}
                        </x-dropdown-link>
